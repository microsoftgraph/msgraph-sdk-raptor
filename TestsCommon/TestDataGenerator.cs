    ...
    public static class KnownIssues
    {
        ...
        public static Dictionary<string, KnownIssue> GetCSharpIssues(Versions versionEnum)
        {
            ...
            return new Dictionary<string, KnownIssue>()
            {
                ...
                { "get-organizationalbrandingproperties-1-csharp-V1-compiles", new KnownIssue(SDK, PutAsyncIsNotSupported) },
                { "update-organizationalbrandingproperties-4-csharp-V1-compiles", new KnownIssue(SDK, PutAsyncIsNotSupported) },
                { "update-organizationalbrandingproperties-8-csharp-V1-compiles", new KnownIssue(SDK, PutAsyncIsNotSupported) },
